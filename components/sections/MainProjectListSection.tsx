...
const MainProjectListSection = () => {
    ...
    const dataProject: ProjectData[] = [
        ...
        {
            id: 6,
            img: '/assets/images/common/project_5.png',
            title: "Submit KYC",
        ...
        {
            id: 7,
            img: '/assets/images/common/project_6.png',
            title: "Verify Wallet",
            desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at nunc non ligula suscipit tincidunt at sit amet nunc.",
            number: "02"
        },
        {
            id: 8,
            img: '/assets/images/common/project_7.png',
            title: "Start Staking",
            desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at nunc non ligula suscipit tincidunt at sit amet nunc.",
            number: "03"
        },
                    ...
                    <div className="row">
                                    ...
                                    {dataTab.map((idx: TabData) => (
                                        <TabPanel key={idx.id} className='content-tab mt40'>
                                            <div className="content-inner project-box-style3_wrapper">
                                                {dataProject.map((item: ProjectData) => (
                                                    <div key={item.id} className="project-box-style3" data-aos="fade-in" data-aos-duration="800">
                                                        <div className="header_project">
                                                            ...
                                                            <h5 className="heading"><Link href="/project_list">{item.title}</Link></h5>
                                                        </div>
                        ...
                        <div className="col-md-12">
                            <ul className="panigation mt6" data-aos="fade-up" data-aos-duration="800">
                                ...
                                {[1, 2, 3].map((page) => (
                                    <li key={page}>
                                        <Link href="#" className={page === 1 ? 'active' : ''}>
                                            {page}
                                        </Link>
                                    </li>
                                ))}
...
export default MainProjectListSection;