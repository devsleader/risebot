...
const dataProject = [
    ...
    {
        id: 18, 
        img: '/assets/images/common/project_22.jpg', // Directly using the image path
        ...
        avt: '/assets/images/common/project_24.png' // Directly using the avatar path
    }, 
    {
        id: 19, 
        img: '/assets/images/common/project_23.jpg', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
    {
        id: 20, 
        img: '/assets/images/common/project_37.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_24.png' // Directly using the avatar path
    }, 
    {
        id: 21, 
        img: '/assets/images/common/project_38.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
    {
        id: 22, 
        img: '/assets/images/common/project_39.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
    {
        id: 23, 
        img: '/assets/images/common/project_40.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
    {
        id: 24, 
        img: '/assets/images/common/project_41.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
    {
        id: 25, 
        img: '/assets/images/common/project_42.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
    {
        id: 26, 
        img: '/assets/images/common/project_43.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
    {
        id: 27, 
        img: '/assets/images/common/project_44.png', // Directly using the image path
        title: "Modern Combat Versus",
        desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
        avt: '/assets/images/common/project_25.png' // Directly using the avatar path
    }, 
                                                                    ...
                                                                    <div className="content">
                                                                        <div className="img-box">
                                                                            <div className="image_inner">
                                                                                ...
                                                                                <div className="shape">
                                                                                    <img
                                                                                        src="/assets/images/common/shape2.png" 
                                                                                        alt="shape"
                                                                                    />
                                                                                </div>
                                                                            </div>
                                                                            <div className="content-inner">
                                                                                <h5 className="heading">
                                                                                    <Link href="/project_details">{item.title}</Link>
                                                                                </h5>
