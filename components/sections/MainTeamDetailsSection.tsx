...
const MainTeamDetailsSection = () => {
    const teamMember: TeamMemberDetails = {
        name: "Darrell Steward",
        position: "Developer",
        image: "/assets/images/common/team_5.png",
        experience: [
            "I have 10 years of software development in different languages",
            "2 years of design experience"
        ],
        contact: {
            email: "darrellsteward@gmail.com",
            phone: "+998 90 808 98 09"
        }
    };
                        ...
                        <div className="col-md-12">
                            <div className="team-details">
                                ...
                                <div className="content">
                                    <h5 className="name">{teamMember.name}</h5>
                                    ...
                                    <div className="box">
                                        ...
                                        <ul>
                                            <li>
                                                <span>Email: <span className="color-hover">{teamMember.contact.email}</span></span>
                                            </li>
                                            <li>
                                                <span>Phone: <span className="white">{teamMember.contact.phone}</span></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default MainTeamDetailsSection;
