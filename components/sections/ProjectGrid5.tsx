...
const img2 = '/assets/images/common/project_1.png';
const img3 = '/assets/images/common/project_2.png';
const img4 = '/assets/images/common/project_3.png';
const img5 = '/assets/images/common/project_4.png';
const img7 = '/assets/images/common/project_5.png';
const img8 = '/assets/images/common/project_6.png';
const img9 = '/assets/images/common/project_7.png';
 ...
 const ProjectGrid5 = () => {
  ...
  return (
    <div className='inner-page project-grid-5 mb30'>
          ...
          <div className="row">
            ...
            <div className="col-md-12">
              <div className="project-wrapper mb30">
                <div className="image-wrapper" data-aos="fade-in" data-aos-duration="1000">
                  <img 
                    src="/assets/images/common/project_84.jpg" 
                    alt="Upcoming pool project" 
                  />
                </div>
            ...
            <div className="col-md-12">
              <div className="project-wrapper">
                <div className="image-wrapper" data-aos="fade-in" data-aos-duration="1000">
                  <img 
                    src="/assets/images/common/project_85.jpg" 
                    alt="Infinity Loop project"
                  />
                </div>
                <div className="content-wrapper">
                  <div className="content_inner" data-aos="fade-left" data-aos-duration="1200">
      ...
      <section className="tf-section project_2 pb60">
        <div className="container">
          <div className="row mb30">
                  ...
                  <div key={item.id} className="project-box-style3" data-aos="fade-in" data-aos-duration="800">
                    <div className="header_project">
                      ...
                      <h5 className="heading">
                        <Link href="/project_details">Angry Birds 2</Link>
                      </h5>
                    </div>
            ...
            <div className="col-md-12">
              <div className="wrap-btn justify-content-center mt30">
                <Link href="/project_details" className="tf-button style1">
                  Show more
                </Link>
              </div>
            </div>
