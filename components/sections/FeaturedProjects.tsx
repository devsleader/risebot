...
const FeaturedProjects = () => {
  // Data directly included in the component
  const data: DataItem[] = [
    {
      id: 1,
      img: '/assets/images/common/project_22.jpg',
      title: "Oddmar",
      ...
      price_2: '23M',
      avt: '/assets/images/common/project_24.png'
    },
    {
      id: 2,
      img: '/assets/images/common/project_23.jpg',
      title: "Modern Combat Versus",
      desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque',
      avt: '/assets/images/common/project_25.png'
    }
  ];
                        ...
                        <div className="content">
                          <div className="img-box">
                            <div className="image_inner">
                              <img 
                                className="mask" 
                                src={item.avt || '/images/avatar/default-avatar.jpg'} 
