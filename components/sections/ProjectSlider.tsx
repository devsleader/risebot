...
const projects: Project[] = [
    ...
    },
    {
        ...
        valuation: "23M",
        baseAllo: "$0",
        image: "/assets/images/common/project_4.png"
    },
];
                                        ...
                                        {projects.map(project => (
                                            <SwiperSlide key={project.id}>
                                                <div className="project-box">
                                                    <div className="image">
                                                        <img className="mask" src={project.image} alt="" />
                                                        <div className="shape">
                                                    ...
                                                    <div className="content">
                                                        ...
                                                        <div className="content-inner">
                                                            <h5 className="heading"><Link href="/project-list">{project.title}</Link></h5>
                                                            <p className="desc">{project.description}</p>
                                                            <ul>
                                                                <li>
                                                                    <p className="text">Total raise:</p>
                                                                    <p className="price">{project.totalRaise}</p>
                                                                </li>
                                                                <li>
                                                                    <p className="text">Valuation:</p>
                                                                    <p className="price">{project.valuation}</p>
                                                                </li>
                                                                <li>
                                                                    <p className="text">Base allo:</p>
                                                                    <p className="price">{project.baseAllo}</p>
                                                                </li>
                                                            </ul>
